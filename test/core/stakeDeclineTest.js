...
contract('TroveManager', async (accounts) => {
  ...
  it("A given trove's stake decline is negligible with adjustments and tiny liquidations", async () => {
    ...
    await borrowerOperations.openTrove(
      ...
      0,
      th._100pct,
      await getOpenTroveSLSDAmount(dec(1, 31), ZERO_ADDRESS),
      ZERO_ADDRESS,
      ZERO_ADDRESS,
    ...
    await borrowerOperations.openTrove(
      ...
      0,
      th._100pct,
      await getOpenTroveSLSDAmount(dec(2, 30), ZERO_ADDRESS),
      ZERO_ADDRESS,
      ZERO_ADDRESS,
    ...
    for (account of tinyTroves) {
      await borrowerOperations.openTrove(
        ...
        0,
        th._100pct,
        await getOpenTroveSLSDAmount(dec(1, 22), ZERO_ADDRESS),
        ZERO_ADDRESS,
        ZERO_ADDRESS,
