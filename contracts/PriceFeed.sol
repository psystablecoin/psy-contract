...
contract PriceFeed is Ownable, CheckContract, BaseMath, Initializable, IPriceFeed {
	...
	function getDirectPrice(address _asset) public view returns (uint256 _priceAssetInSLSD) {
		...
		_priceAssetInSLSD = scaledChainlinkPrice.mul(1 ether).div(scaledChainlinkIndexPrice);
	}
